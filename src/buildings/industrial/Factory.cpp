...
// }
Factory::Factory(int id)
    : IndustrialBuilding(id, 100, "Factory", 25, 250, 50, 50, 50, 50, statistics), satisfactionScore(25), numberOfEmployees(100), partProductionPerHour(300), productionCostPerHour(100) {}
